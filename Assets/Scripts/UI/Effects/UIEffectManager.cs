...
using DG.Tweening;
using WheelGame.UI.Pooling;

namespace WheelGame.UI.Effects
{
public class UIEffectManager : MonoBehaviour
{
    ...
    [Header("Dependencies")]
    [SerializeField] private IconPool iconPool;
    ...
    public void PlayCollectAnimation(Canvas canvas, Sprite icon, Vector3 startWorldPos, RectTransform targetSlot, System.Action onComplete)
    {
        ...
        // 1. Fetch from Pool
        GameObject flyer = iconPool.GetIcon(canvas.transform);
        ...
        s.OnComplete(() =>
        {
            if (flyer != null) iconPool.ReturnIcon(flyer);
